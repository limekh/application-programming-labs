...
from plot_histogram import create_histogram
from plot_histogram import show_histogram
...
def parse_arguments():
    ...
    parser.add_argument('-op', '--output_path', type=str, help='Path for save image')
...
def main():
    ...
    try:
        ...
        save_image(args.output_path, cropped_image)
